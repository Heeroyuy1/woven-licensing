...
1. Run the licensing server: `docker compose up -d` or `uvicorn app.main:app --port 8000`
2. Generate a license via admin API or portal
...
*Stratum v1.3.0 | © Woven Model. All rights reserved. | This document does not constitute financial advice. Always perform your own due diligence before making trading decisions.*
